...
RSpec.describe UserAuth, type: :model do
  ...
  describe 'methods' do
    ...
    describe 'send_confirmation_instructions' do
      let!(:user_auth) { create :user_auth, user: user, provider: provider, uid: uid }
      let!(:user) { create :user }

      subject { user_auth.send_confirmation_instructions }

      context 'user_auth is email' do
        let(:provider) { :email }
        let(:uid) { 'foo@example.com' }
      ...
      context 'user_auth is socail_provider' do
