...
RSpec.describe WebpackBundleHelper, type: :helper do
  before do
    manifest = {
      "item_group_editor.css": '/packs/item_group_editor-5d7c7164b8a0a9d675fad9ab410e.css',
      "item_group_editor.js": '/packs/item_group_editor-857e5bfa272e71b6384046f6.js',
      "item_group_editor.js.map": '/packs/item_group_editor.js.map',
      "union-ok.png": '/packs/union-ok-857e5bfa272e71b6384046f6.png',
      "union-ok@2x.png": '/packs/union-ok@2x-5d7c7164b8a0a9d675fad9ab410e.png'
    }.stringify_keys
  ...
  describe '#asset_bundle_path' do
    context 'given existing *.js entry name' do
      ...
      it 'returns actual file name' do
        is_expected.to eq '/packs/item_group_editor-857e5bfa272e71b6384046f6.js'
      end
    end
    ...
    context 'given existing *.css entry name' do
      ...
      it 'returns actual file name' do
        is_expected.to eq '/packs/item_group_editor-5d7c7164b8a0a9d675fad9ab410e.css'
      end
    end
  ...
  describe '#javascript_bundle_tag' do
    context 'given existing *.js entry name' do
      ...
      it 'renders a nice <script> tag' do
        is_expected.to eq '<script src="/packs/item_group_editor-857e5bfa272e71b6384046f6.js" defer="defer"></script>'
      end
    end
    ...
    context 'given existing *.js entry name with async' do
      ...
      it 'renders a nice <script> tag' do
        is_expected.to eq '<script src="/packs/item_group_editor-857e5bfa272e71b6384046f6.js" async="async"></script>'
      end
    end
  ...
  describe '#stylesheet_bundle_tag' do
    context 'given existing *.css entry name' do
      ...
      it 'renders a nice <link> tag' do
        is_expected.to eq(
          '<link rel="stylesheet" media="screen" href="/packs/item_group_editor-5d7c7164b8a0a9d675fad9ab410e.css" />'
        )
      end
    end
  ...
  describe '#image_bundle_tag' do
    context 'given existing *.png entry name' do
      ...
      it 'renders a nice <img> tag' do
        is_expected.to eq '<img alt="Union ok" src="/packs/union-ok-857e5bfa272e71b6384046f6.png" />'
      end
    end
